  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <section className="relative container mx-auto px-4 py-24 md:py-36">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/courses">
              <button className="group relative bg-white text-black font-semibold text-lg px-8 py-4 rounded-tr-2xl rounded-bl-2xl rounded-tl-md rounded-br-md hover:bg-white/90 transition-all duration-300 flex items-center gap-2">
                Browse Courses
                <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </button>
            </Link>
            <Link href="/sign-up">
              <button className="border border-white/20 text-white font-medium text-lg px-8 py-4 rounded-tl-2xl rounded-br-2xl rounded-tr-md rounded-bl-md hover:bg-white/5 hover:border-white/30 transition-all duration-300 flex items-center gap-2">
      ...
      <section className="relative container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto grid grid-cols-3 gap-8 border-y border-white/10 py-12">
          <div className="text-center">
            <p className="text-4xl md:text-5xl font-bold text-white mb-2">10K+</p>
            <p className="text-white/50 text-sm uppercase tracking-wider">Active Users</p>
          </div>
          <div className="text-center">
            <p className="text-4xl md:text-5xl font-bold text-primary mb-2">500+</p>
            <p className="text-white/50 text-sm uppercase tracking-wider">Courses Reviewed</p>
          </div>
          <div className="text-center">
            <p className="text-4xl md:text-5xl font-bold text-white mb-2">50K+</p>
            <p className="text-white/50 text-sm uppercase tracking-wider">Reviews Posted</p>
          </div>
        </div>
      </section>
      ...
      <section className="relative container mx-auto px-4 py-24">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {/* Feature Card 1 */}
          <div className="group p-8 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-primary/50 hover:bg-white/[0.05] transition-all duration-300">
          ...
          <div className="group p-8 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-primary/50 hover:bg-white/[0.05] transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Detailed Ratings</h3>
            <p className="text-white/50 leading-relaxed">
          ...
          <div className="group p-8 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-primary/50 hover:bg-white/[0.05] transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Creator Tools</h3>
            <p className="text-white/50 leading-relaxed">
      ...
      <section className="relative container mx-auto px-4 py-24 bg-white/[0.02]">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 tracking-tight">
            How It Works
          </h2>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={item.step} className="flex gap-5 group">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-primary font-mono font-bold text-sm group-hover:bg-primary/10 group-hover:border-primary/30 transition-colors">
                    {item.step}
                  </div>
                  <div>
      ...
      <section className="relative container mx-auto px-4 py-24">
        ...
        <div className="relative max-w-3xl mx-auto text-center p-12 md:p-16 rounded-3xl bg-white/[0.03] border border-white/10 backdrop-blur-sm">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 tracking-tight">
          ...
          <Link href="/sign-up">
            <button className="group bg-primary text-black font-semibold text-lg px-10 py-4 rounded-tr-2xl rounded-bl-2xl rounded-tl-md rounded-br-md hover:bg-primary/90 transition-all duration-300 flex items-center gap-2 mx-auto">
              Create Your Account
              <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
            </button>
          </Link>
